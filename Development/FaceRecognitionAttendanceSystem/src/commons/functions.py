...
def initialize_folder():
	...
	if not os.path.exists(home+"/src"):
		...
		print("Directory ", home, "/src created")

	if not os.path.exists(home+"/src/weights"):
		os.makedirs(home+"/src/weights")
		print("Directory ", home, "/src/weights created")

def get_deepface_home():
	return str(os.path.abspath(os.getcwd())) #jh
...
def find_input_shape(model): # jh: use in realtime.py
